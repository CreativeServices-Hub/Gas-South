...
lib.ssMetadata = [
		{name:"320x250___atlas_1", frames: [[0,766,469,118],[0,886,487,106],[0,502,429,262],[431,502,220,58],[0,0,600,500]]}
];
...
(lib.Bitmap2 = function() {
	this.initialize(ss["320x250___atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib._320x250___ = function(mode,startPosition,loop,reversed) {
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/320x250___atlas_1.png", id:"320x250___atlas_1"}
	],
	preloads: []
};
